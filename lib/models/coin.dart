...
class Coin extends SpriteComponent with HasGameRef {
  ...
  Coin() : super(size: Vector2(30, 30)); // Size of the coin
  ...
  Future<void> onLoad() async {
    ...
    position = Vector2(
      _random.nextDouble() * gameRef.size.x, // Random x position within screen width
      gameRef.size.y - 100, // Set it to spawn near the bottom (adjust as needed)
    );
  }
